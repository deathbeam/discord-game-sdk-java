...
public class IDiscordLobbySearchQuery extends Structure {
	...
	public io.github.deathbeam.discordgamesdk.jna.IDiscordRelationshipManager.filter_callback filter;
	 ...
	 */
	public IDiscordLobbySearchQuery(io.github.deathbeam.discordgamesdk.jna.IDiscordRelationshipManager.filter_callback filter, IDiscordLobbySearchQuery.sort_callback sort, IDiscordLobbySearchQuery.limit_callback limit, IDiscordLobbySearchQuery.distance_callback distance) {
		super();
		this.filter = filter;
		this.sort = sort;
		this.limit = limit;
