...
public class DiscordCreateParams extends Structure {
	...
	public io.github.deathbeam.discordgamesdk.jna.IDiscordUserEvents.ByReference user_events;
	/** C type : DiscordVersion */
	...
	public io.github.deathbeam.discordgamesdk.jna.IDiscordActivityEvents.ByReference activity_events;
	/** C type : DiscordVersion */
	public int activity_version;
	/** C type : IDiscordRelationshipEvents* */
	public io.github.deathbeam.discordgamesdk.jna.IDiscordRelationshipEvents.ByReference relationship_events;
	/** C type : DiscordVersion */
	public int relationship_version;
	/** C type : IDiscordLobbyEvents* */
	public io.github.deathbeam.discordgamesdk.jna.IDiscordLobbyEvents.ByReference lobby_events;
	/** C type : DiscordVersion */
	public int lobby_version;
	/** C type : IDiscordNetworkEvents* */
	public io.github.deathbeam.discordgamesdk.jna.IDiscordNetworkEvents.ByReference network_events;
	/** C type : DiscordVersion */
	public int network_version;
	/** C type : IDiscordOverlayEvents* */
	public io.github.deathbeam.discordgamesdk.jna.IDiscordOverlayEvents.ByReference overlay_events;
	/** C type : DiscordVersion */
	...
	public io.github.deathbeam.discordgamesdk.jna.IDiscordStoreEvents.ByReference store_events;
	/** C type : DiscordVersion */
	public int store_version;
	/** C type : IDiscordVoiceEvents* */
	public io.github.deathbeam.discordgamesdk.jna.IDiscordVoiceEvents.ByReference voice_events;
	/** C type : DiscordVersion */
	public int voice_version;
	/** C type : IDiscordAchievementEvents* */
	public io.github.deathbeam.discordgamesdk.jna.IDiscordAchievementEvents.ByReference achievement_events;
	/** C type : DiscordVersion */
